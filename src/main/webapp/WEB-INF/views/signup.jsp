...
<body>
	...
	<form action="signup" method="post">
		...
		<p>
<label for="name">phone:</label> <input id="phone" name="phone"  type="text" value="<c:out value="${ param.phone }"/>" pattern="[2-9]{1}[0-9]{2}-[0-9]{3}-[0-9]{4}" placeholder="###-###-####" autocomplete="off"/>		</p>
		<p>
