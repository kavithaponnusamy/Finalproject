...
public class HomeController {
	...
	public String showDetails(Model model, @RequestParam(required = false) String propertyId) {
		...
		// adding this session variable for favorites as we are not saving the detail
		// page url
	...
	public String addToLifestyle(Model model, @RequestParam(required = false) String pets,
			@RequestParam(required = false) String kids, @RequestParam(required = false) String active,
			@RequestParam(required = false) String nightLife, @RequestParam(required = false) String publicTransit) {
	...
	public String updateLifestyle(Model model, @RequestParam(required = false) String propertyId,
			@RequestParam(required = false) String pets, @RequestParam(required = false) String kids,
			@RequestParam(required = false) String active, @RequestParam(required = false) String nightLife,
			@RequestParam(required = false) String publicTransit) {
